<template>
   <div class="container d-flex modal_background">
     <figure class="card card-product-grid card-lg"> <a href="#" class="img-wrap" data-abc="true"> <img src="https://i.imgur.com/lLs9Gao.jpg"> </a>
...
<style scoped>
  ...
  .modal_background
  {
      ...
      background-image: url('/src/assets/img/brume.jpg');
      /* Réglez les autres propriétés de fond selon vos préférences */
      background-size: cover;
      background-position: center;
      background-repeat: no-repeat;
      /* Autres styles */
      border: none; /* Pour supprimer la bordure du modal */
  }
